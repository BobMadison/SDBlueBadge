    ...
    public class SWAPIService
    {
        ...
        public async Task<Person> GetPersonAsync(int id)
        {
            HttpResponseMessage response = 
                await _client.GetAsync($"https://swapi.dev/api/people/{id}/");
        ...
        {
            HttpResponseMessage response = 
                await _client.GetAsync($"https://swapi.dev/api/planets/{id}/");
            ...
            return new Planet() { Name = "Krypton" };
            // or return null;
        }
        ...
        {
            HttpResponseMessage response = 
                await _client.GetAsync($"https://swapi.dev/api/people/?search={query}");
        ...
        {
            HttpResponseMessage response =
                await _client.GetAsync($"https://swapi.dev/api/{table}/?search={query}");
